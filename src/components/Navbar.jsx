...
const Navbar = () => {
    ...
    return (
        ...
        {/* mobile menu */}
         <ul className={!nav ?  "hidden" : "absolute top-0 left-0 w-full h-screen bg-[#0a192f] text-gray-400 flex flex-col justify-center items-center" }>
                ...
                <li className="py-6 text-3xl"><Link  onClick={handleClick} to="work" smooth={true} duration={500} >Project</Link></li>
